...
function ContractAddress({ label, address }: ContractAddressProps) {
  return (
    <div className="bg-[#141414] border border-gray-700 p-4 hover:border-[#EBF73F] transition duration-150 relative">
      ...
      <div className="text-sm text-[#EBF73F] font-mono break-all">{address}</div>
    </div>
  );
}
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <MetricCard
          ...
          value="133,390,828"
          description="The amount of coins that are circulating in the market and areվելable by the public. It is comparable to looking at shares readily available in the market (not held & locked by insiders, governments)."
          username="nodeops"
          timestamp="18h"
        />
        ...
        <MetricCard
          ...
          value="658,468,718"
          description="The amount of coins that have already been created, minusiles any coins that have been burned (removed from circulation). It is comparable to outstanding shares in the stock market. Total Supply = Onchain supply - burned tokens"
          username="nodeops"
          timestamp="18h"
        />
